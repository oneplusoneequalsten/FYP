...
public class TVModule {
    ...
    public TVModule(String original_title, String title, String poster_path, String backdrop_path, String release_date, String overview, String vote_average, String vote_count) {
