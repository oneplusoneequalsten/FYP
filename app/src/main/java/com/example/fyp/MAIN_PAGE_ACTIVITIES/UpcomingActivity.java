...
public class UpcomingActivity extends AppCompatActivity {
    ...
    private void fetchAnimes() {
        ...
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=46fd53a3c0ad52d081ffe85fb24fccd0&language=en-US&page=1";
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, response -> {
            ...
            AnimeMainAdapter adapter = new AnimeMainAdapter(UpcomingActivity.this, animeList);
            recyclerViewAll.setAdapter(adapter);
        }, error -> {
            Toast.makeText(UpcomingActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            progressBar.setVisibility(View.INVISIBLE);
        });
